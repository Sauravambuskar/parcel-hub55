  ...
  return <div className="mb-8">
      ...
      <div className="relative">
        <div className="flex items-start justify-between gap-1">
          ...
          return <div key={step} className="flex flex-col items-center relative flex-1 min-w-0">
                {/* Connecting Line */}
                {index < totalSteps - 1 && <div className={cn("absolute top-4 left-[50%] right-[-50%] h-0.5 -translate-y-1/2 transition-colors duration-500 -z-0", isCompleted ? "bg-primary" : "bg-muted")} />}
                
                {/* Step Circle */}
                <div className={cn("relative z-10 w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium border-2 transition-all duration-300 leading-none shrink-0", isCompleted && "bg-secondary border-secondary text-primary", isCurrent && "border-primary bg-secondary text-primary scale-110 shadow-[0_0_15px_hsl(180_100%_75%/0.4)]", !isCompleted && !isCurrent && "border-muted bg-secondary text-primary")}>
