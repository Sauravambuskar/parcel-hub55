    ...
    <div className="space-y-8">
      <div className="text-center space-y-3">
        ...
        <p className="text-muted-foreground max-w-md mx-auto">
          Select the type of delivery service you need for your shipment
        </p>
      </div>
      ...
      <div className="grid gap-4">
        ...
        <Card 
          className={cn(
            ...
            "bg-gradient-to-br from-primary/5 via-background to-primary-glow/5",
      ...
      <div className="pt-2">
        <Button 
          onClick={onNext} 
          className="w-full h-14 text-base font-semibold gap-2 group"
        >
